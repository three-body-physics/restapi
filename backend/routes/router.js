...
router.get("/api/trivia/:userid", passport.authenticate("jwt-2", {session: false}), triviaController.retreiveUser);
router.post("api/trivia/:userid"), passport.authenticate("jwt-2", {session: false}), triviaController.updateUserRecord);
